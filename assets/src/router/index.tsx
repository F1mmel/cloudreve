        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                path: "customization",
                async lazy() {
                  let { Customization } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: Customization };
                },
              },
              {
                path: "storage-map",
                async lazy() {
                  let { StorageTreemap } = await import("../component/Admin/AdminBundle.tsx");
                  return { Component: StorageTreemap };
                },
              },
