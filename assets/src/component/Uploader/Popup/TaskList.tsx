...
const StyledDialog = styled(Dialog)(({ fullScreen, theme }) => ({
  ...
  "body.has-custom-background & .MuiDialog-paper": {
    backgroundColor:
      theme.palette.mode === "light" ? "rgba(255, 255, 255, 0.45)" : "rgba(18, 18, 18, 0.95)",
    backdropFilter: "blur(12px) saturate(180%)",
  },
  "body.has-custom-background & .MuiAccordion-root": {
    backgroundColor: "transparent",
  },
  "body.has-custom-background & .MuiAppBar-root": {
    backgroundColor: "transparent",
  },
  ...(fullScreen
    ? {
