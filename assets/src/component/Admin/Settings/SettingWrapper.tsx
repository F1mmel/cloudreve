  ...
  const submit = () => {
    ...
    dispatch(
      ...
      .then(async (res) => {
        ...
        // Reload basic config to apply background changes globally in UI instantly
        try {
          const { loadSiteConfig } = await import("../../../redux/thunks/site.ts");
          dispatch(loadSiteConfig("basic"));
        } catch (e) {
          console.error(e);
        }
      })
